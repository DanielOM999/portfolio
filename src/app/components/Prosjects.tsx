...
export default function Projects() {
  const [projects] = useState<Project[]>([
    ...
    },
    {
      ...
      image: '/img/eCP.webp?height=300&width=400',
      link: 'https://swiftbinderub.no/',
    },
    {
      id: 3,
      ...
      description:
        'An intelligent chatbot built with Python and TensorFlow, offering real-time customer support and query resolution.',
      technologies: ['Python', 'TensorFlow', 'Flask', 'OpenAI API'],
      image: '/img/AICB.webp?height=300&width=400',
      link: 'https://swiftbinderub.no/',
    },
    {
      id: 4,
      ...
      description:
        'A mobile app for tracking fitness activities, built with Flutter and Firebase, featuring GPS tracking and analytics.',
      technologies: ['Flutter', 'Firebase', 'Dart', 'Google Maps API'],
      image: '/img/fApp.webp?height=300&width=400',
      link: 'https://swiftbinderub.no/',
    },
  ]);
